...
def is_palindrome(x):
    ...
    :param
        x: The number to check fort palindromicity.
    :return:
...
class Tests(unittest.TestCase):
    ...
    def test_negative(self):
        ...
        self.assertFalse(is_palindrome(4321))

    def test_positive(self):
        "Check that it returns True correctly."
        self.assertTrue(is_palindrome(14641))

    def test_single_digit(self):
        "Check that it works for single digits numbers"
        for i in range(10):
